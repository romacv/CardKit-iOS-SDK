...
#ifndef THREEDSSDK_SWIFT_H
#define THREEDSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ThreeDSSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol SDKChallengeProtocol;

SWIFT_PROTOCOL("_TtP10ThreeDSSDK24GenericChallengeProtocol_")
...
/// Nuke APIs.
/// The protocol is defined as <code>@objc</code> to enable users to override its methods
/// in extensions (e.g. you can override <code>display(image:)</code> in <code>UIImageView</code> subclass).
SWIFT_PROTOCOL("_TtP10ThreeDSSDK15ImageDisplaying_")
@protocol ImageDisplaying
- (void)displayWithImage:(UIImage * _Nullable)image;
@end


SWIFT_PROTOCOL("_TtP10ThreeDSSDK28MultiSelectChallengeProtocol_")
...
SWIFT_PROTOCOL("_TtP10ThreeDSSDK26OutOfBandChallengeProtocol_")
@protocol OutOfBandChallengeProtocol <GenericChallengeProtocol>
@end


SWIFT_PROTOCOL("_TtP10ThreeDSSDK20SDKChallengeProtocol_")
@protocol SDKChallengeProtocol
- (void)handleChallenge;
@end


SWIFT_PROTOCOL("_TtP10ThreeDSSDK31SingleSelectorChallengeProtocol_")
@protocol SingleSelectorChallengeProtocol <GenericChallengeProtocol>
- (void)selectObject:(NSInteger)index;
@end


SWIFT_PROTOCOL("_TtP10ThreeDSSDK21TextChallengeProtocol_")
...
@interface UIImageView (SWIFT_EXTENSION(ThreeDSSDK)) <ImageDisplaying>
/// Displays an image.
- (void)displayWithImage:(UIImage * _Nullable)image;
@end
...
SWIFT_PROTOCOL("_TtP10ThreeDSSDK20WebChallengeProtocol_")
